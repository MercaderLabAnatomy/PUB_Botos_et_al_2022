...
mkdir -p $PWD/primary_assembly_genome_indexed_150 && cd $_

#Set the output of the indexed genome folder.
mkdir -p $PWD/150genomeDirectory
genomeDir="$PWD/150genomeDirectory"
...
#Set the output path.
out_dict=/data/users/mbotos/PhDAnalysis/references/ensembl/release102/fasta/${name}_150.dict
out_fasta=/data/users/mbotos/PhDAnalysis/references/ensembl/release102/fasta/${name}_150.fai
