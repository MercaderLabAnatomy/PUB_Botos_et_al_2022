...
mkdir -p $PWD/primary_assembly_genome_indexed_75 && cd $_

#Set the output of the indexed genome folder.
mkdir -p $PWD/75genomeDirectory
genomeDir="$PWD/75genomeDirectory"
...
#Set the output path.
out_dict=/data/users/mbotos/PhDAnalysis/references/ensembl/release102/fasta/${name}_75.dict
out_fasta=/data/users/mbotos/PhDAnalysis/references/ensembl/release102/fasta/${name}_75.fai
