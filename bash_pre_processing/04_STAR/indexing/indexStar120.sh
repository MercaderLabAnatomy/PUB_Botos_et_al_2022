...
mkdir -p $PWD/primary_assembly_genome_indexed_120 && cd $_

#Set the output of the indexed genome folder.
mkdir -p $PWD/120genomeDirectory
genomeDir="$PWD/120genomeDirectory"
...
#Set the output path.
out_dict=/data/users/mbotos/PhDAnalysis/references/ensembl/release102/fasta/${name}_120.dict
#Only assigns to the original file the .fa.fai file but does not outputs in a file name.
#out_fasta=/data/users/mbotos/PhDAnalysis/references/ensembl/release102/fasta/${name}_120.fai
