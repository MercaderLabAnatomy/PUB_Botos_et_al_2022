...
inputFiles="/data/users/mbotos/PhDAnalysis/quality_check/fastp/results_p_nv/results_fastp_p_nv/120"
...
indexedReference="/data/users/mbotos/PhDAnalysis/STAR/indexing/index120/primary_assembly_genome_indexed_120/120genomeDirectory"
...
files=($(ls -1 $inputFiles/*_1*.fastq)) #| sort -V))
...
outfq1=($(basename $fq1 _1_trim.fastq)) #| cut -d_ -f1,2,5))
alignedOut=${outfq1}_
