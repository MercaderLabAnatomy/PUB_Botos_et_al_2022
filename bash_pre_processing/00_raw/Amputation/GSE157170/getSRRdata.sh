...
inputFiles="/data/users/mbotos/PhDdataSets/Datasets/Danio_rerio/RNAseq/Amputation/GSE157170/SRR_Acc_List.txt"
...
outPath="/data/users/mbotos/PhDdataSets/Datasets/Danio_rerio/RNAseq/Amputation/GSE157170/"
...
fastq-dump --split-e --skip-technical ${array[$SLURM_ARRAY_TASK_ID]} --outdir $outPath
#removed fasterq-dump
