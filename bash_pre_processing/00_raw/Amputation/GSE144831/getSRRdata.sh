...
inputFiles="/data/users/mbotos/PhDdataSets/Datasets/Danio_rerio/RNAseq/Amputation/GSE144831/SRR_Acc_List.txt"
...
outPath="/data/users/mbotos/PhDdataSets/Datasets/Danio_rerio/RNAseq/Amputation/GSE144831/"
...
fastq-dump --split-e --skip-technical ${array[$SLURM_ARRAY_TASK_ID]} -O $outPath
