...
setwd("PUB_Botos_et_al_2022-main/")
register(MulticoreParam())


##Load the data
files <- list.files(all.files = TRUE,
                    path = "02_Data/STAR/mapping/release102",
...
#files
name_files <- gsub("02_Data/STAR/mapping/release102/","",files)
#Substitute all the string for a shorter name.
...
read.table(files[1],header = TRUE)[,c(1,3)]
...
colnames(mc_s2c) <- "ID"
s2c <- data.frame(read.table("02_Data/STAR/mapping/release102/table_mapps.tsv",
                             sep = "\t",
                             header = TRUE))

s2c_raw <- data.frame(read.table("02_Data/STAR/mapping/release102/s2c_raw.tsv",
                                 sep="\t",
                                 header = TRUE))
...
dir.create(path = "BatchCorrected",recursive = TRUE)
write.table(file = "BatchCorrected/colData_s4c.txt",x = s4c,row.names = TRUE,col.names = TRUE,sep = "\t")
...
pca_var_plot_func <- function(df,var,subtitle,percentVar_obj,pca,pcb){
  ...
  n <- n + geom_jitter(position = position_jitter(width = 0.000000001,height = 0.000000001,seed = 123456),size=8)
  n}
```
...
dir.create("Graphs_f/PCA/RAW/", recursive = TRUE)
ggsave(filename ="Graphs_f/PCA/RAW/PCA_Raw_Counts.svg",
       device = "svg",
...
lapply(names(pca_raw_pc1_pc2_list),function(plotIt){
  ggsave(filename = paste0("Graphs_f/PCA/RAW/PCA_RAW_",plotIt,"_Counts.svg"),plot = pca_raw_pc1_pc2_list[[plotIt]],device = "svg",dpi = 320,width = 12,height = 10)
...
dir.create("Graphs_f/PCA/RAW/PC1PC3", recursive = TRUE)
ggsave(filename =paste0("Graphs_f/PCA/RAW/PC1PC3/PCA_Raw_Counts_PC1_PC3.svg"),
       device = "svg",
...
lapply(names(pca_raw_pc1_pc3_list),function(plotIt){
  ggsave(filename = paste0("Graphs_f/PCA/RAW/PC1PC3/PCA_RAW_",plotIt,"pc1_pc3_Counts.svg"),plot = pca_raw_pc1_pc3_list[[plotIt]],device = "svg",dpi = 320,width = 12,height = 10)
})
```
...
dir.create("Graphs_f/PCA/RAW/PC1PC4", recursive = TRUE)
ggsave(filename =paste0("Graphs_f/PCA/RAW/PC1PC4/PCA_Raw_Counts_PC1_PC4.svg"),
       device = "svg",
...
lapply(names(pca_raw_pc1_pc4_list),function(plotIt){
  ...
  ggsave(filename = paste0("Graphs_f/PCA/RAW/PC1PC4/PCA_RAW_",plotIt,"pc1_pc4_Counts.svg"),plot = pca_raw_pc1_pc4_list[[plotIt]],device = "svg",dpi = 320,width = 12,height = 10)
...
dir.create("Graphs_f/PCA/RAW/PC3PC4", recursive = TRUE)
ggsave(filename =paste0("Graphs_f/PCA/RAW/PC3PC4/PCA_Raw_Counts_PC3_PC4.svg"),
       device = "svg",
...
lapply(names(pca_raw_pc3_pc4_list),function(plotIt){
  ggsave(filename = paste0("Graphs_f/PCA/RAW/PC3PC4/PCA_RAW_",plotIt,"pc3_pc4_Counts.svg"),plot = pca_raw_pc3_pc4_list[[plotIt]],device = "svg",dpi = 320,width = 12,height = 10)
...
dir.create("Graphs_f/UMAP/RAW/",recursive = TRUE)
...
ggsave(filename = "Graphs_f/UMAP/RAW/UMAP_Raw_Counts.svg",
       device = "svg",
       dpi = 320,
...
p_Platform_Platform <- pca_var_plot_func(df = pca_corrected_Platform_df,var = "Platform",subtitle = "Batch Corrected for Platform",percentVar_obj = percentVar_corrected_obj_Platform,pca = 1,pcb = 2)

p_Platform_Len <- pca_var_plot_func(df = pca_corrected_Platform_df,var = "Length",subtitle = "Batch Corrected for Platform",percentVar_obj = percentVar_corrected_obj_Platform,pca = 1,pcb = 2)
p_Platform_Lib <- pca_var_plot_func(df = pca_corrected_Platform_df,var = "Library",subtitle = "Batch Corrected for Platform",percentVar_obj = percentVar_corrected_obj_Platform,pca = 1,pcb = 2)
p_Platform_LabLib <- pca_var_plot_func(df = pca_corrected_Platform_df,var = "LabLib",subtitle = "Batch Corrected for Platform",percentVar_obj = percentVar_corrected_obj_Platform,pca = 1,pcb = 2)
p_Platform_Ext <- pca_var_plot_func(df = pca_corrected_Platform_df,var = "Extract",subtitle = "Batch Corrected for Platform",percentVar_obj = percentVar_corrected_obj_Platform,pca = 1,pcb = 2)
p_Platform_Lab <- pca_var_plot_func(df = pca_corrected_Platform_df,var = "Lab",subtitle = "Batch Corrected for Platform",percentVar_obj = percentVar_corrected_obj_Platform,pca = 1,pcb = 2)
p_Platform_Tissue <- pca_var_plot_func(df = pca_corrected_Platform_df,var = "Tissue",subtitle = "Batch Corrected for Platform",percentVar_obj = percentVar_corrected_obj_Platform,pca = 1,pcb = 2)


dir.create("Graphs_f/PCA/BATCH/Platform", recursive = TRUE)
ggsave(filename = paste0("Graphs_f/PCA/BATCH/Platform/PCA_combatseq_Platform_batch_corrected_Counts.svg"),
       device = "svg",
       dpi = 320,
...
```{r}
dir.create(recursive = TRUE,path = "Graphs_f/PCA/BATCH/")
...
lapply(names(pca_batch_pc1_pc2_list),function(plotIt){
  ggsave(filename = paste0("Graphs_f/PCA/BATCH/PCA_BATCH_",plotIt,"pc1_pc2_Counts.svg"),plot = pca_batch_pc1_pc2_list[[plotIt]],device = "svg",dpi = 320,width = 12,height = 10)
...
dir.create("Graphs_f/UMAP/BATCH", recursive = TRUE)

ggsave(filename = "Graphs_f/UMAP/BATCH/UMAP_combatseq_Platform_batch_corrected_Counts.svg",
       device = "svg",
       dpi = 320,
...
dir.create("Graphs_f/PCA/BATCH/PC1PC3")
ggsave(filename = paste0("Graphs_f/PCA/BATCH/PC1PC3/PCA_combatseq_Platform_batch_corrected_Counts_PC1_PC3.svg"),
       device = "svg",
       dpi = 320,
...
```{r}
dir.create(recursive = TRUE,path = "Graphs_f/PCA/BATCH/PC1PC3")
...
lapply(names(pca_batch_pc1_pc3_list),function(plotIt){
  ggsave(filename = paste0("Graphs_f/PCA/BATCH/PC1PC3/PCA_BATCH_",plotIt,"pc1_pc3_Counts.svg"),plot = pca_batch_pc1_pc3_list[[plotIt]],device = "svg",dpi = 320,width = 12,height = 10)
})
```
...
dir.create("Graphs_f/PCA/BATCH/PC1PC4", recursive = TRUE)
  ggsave(filename = paste0("Graphs_f/PCA/BATCH/PC1PC4/PCA_combatseq_Platform_batch_corrected_Counts_PC1_PC4.svg"),device = "svg",
       dpi = 320,
...
```
```{r}
dir.create(recursive = TRUE,path = "Graphs_f/PCA/BATCH/PC1PC4")
...
lapply(names(pca_batch_pc1_pc4_list),function(plotIt){
  ggsave(filename = paste0("Graphs_f/PCA/BATCH/PC1PC4/PCA_BATCH_",plotIt,"pc1_pc4_Counts.svg"),plot = pca_batch_pc1_pc4_list[[plotIt]],device = "svg",dpi = 320,width = 12,height = 10)
...
dir.create("Graphs_f/PCA/BATCH/", recursive = TRUE)
ggsave(filename = "Graphs_f/PCA/BATCH/PCA_combatseq_Platform_batch_corrected_Counts_PC3_PC4.svg",
       device = "svg",
       dpi = 320,
...
```{r}
dir.create(recursive = TRUE,path = "Graphs_f/PCA/BATCH/PC3PC4")
...
lapply(names(pca_batch_pc3_pc4_list),function(plotIt){
  ggsave(filename = paste0("Graphs_f/PCA/BATCH/PC3PC4/PCA_BATCH_",plotIt,"pc3_pc4_Counts.svg"),plot = pca_batch_pc3_pc4_list[[plotIt]],device = "svg",dpi = 320,width = 12,height = 10)
})
```
...
dir.create(recursive = TRUE,path = "Graphs_f/PCA/BATCH/Library")
...
ggsave(filename = "Graphs_f/PCA/BATCH/Library/PCA_combatseq_Library_batch_corrected_Counts.svg",
       device = "svg",
       dpi = 320,
...
lapply(names(pca_batch_lib_pc1_pc2_list),function(plotIt){
  ggsave(filename = paste0("Graphs_f/PCA/BATCH/Library/PCA_BATCH_libray",plotIt,"pc1_pc2_Counts.svg"),plot = pca_batch_lib_pc1_pc2_list[[plotIt]],device = "svg",dpi = 320,width = 12,height = 10)
})
```
...
ggsave(filename = "Graphs_f/UMAP/BATCH/UMAP_combatseq_Library_batch_corrected_Counts.svg",
       device = "svg",
       dpi = 320,
...
dir.create(recursive = TRUE,"Graphs_f/PCA/BATCH/Length/")
...
ggsave(filename = "Graphs_f/PCA/BATCH/Length/PCA_combatseq_Length_batch_corrected_Counts.svg",
       device = "svg",
       dpi = 320,
...
```{r}
dir.create(recursive = TRUE,path = "Graphs_f/PCA/BATCH/Length/")
...
lapply(names(pca_batch_len_pc1_pc2_list),function(plotIt){
  ggsave(filename = paste0("Graphs_f/PCA/BATCH/Length/PCA_BATCH_length",plotIt,"pc1_pc2_Counts.svg"),plot = pca_batch_len_pc1_pc2_list[[plotIt]],device = "svg",dpi = 320,width = 12,height = 10)
...
ggsave(filename = "Graphs_f/PCA/BATCH/PCA_combatseq_Length_Platform_Library_batch_corrected_Counts.svg",
       device = "svg",
       dpi = 320,
...
ggsave(filename = "Graphs_f/UMAP/BATCH/UMAP_combatseq_Length_batch_corrected_Counts.svg",
       device = "svg",
       dpi = 320,
...
runModellEdgeR <- function(modell_in,modell_name){
  ...
  ggsave(filename =paste0("BatchCorrected/edgeR/",modell_name,"/Graphs/PCA_edgeR_Normalizations_",modell_name,"_batch_corrected_Counts.svg"),
         dpi = 320,
         device = "svg",
  ...
  lapply(mylist_res,function(x) {
    write.table(x = x,
                ...
                file = paste0("BatchCorrected/edgeR/",
                              modell_name,
                              "/Contrasts_Results/",
                              x[["contrastName"]][1],
                              "_analysis_rna_",
...
require("dplyr")
modell_name = "Length"
dir.create(recursive = TRUE,path = paste0("BatchCorrected/edgeR/",modell_name))
dir.create(recursive = TRUE,path = paste0("BatchCorrected/edgeR/",modell_name,"/Contrasts_Results"))
dir.create(recursive = TRUE,path =paste0("BatchCorrected/edgeR/",modell_name,"/Graphs"))
...
dir.create("Graphs_f/UMAP/NORMALIZED/", recursive = TRUE)
ggsave(filename = paste0("Graphs_f/UMAP/NORMALIZED/UMAP_EDGER_TMM_Platform_Counts.svg"),
       device = "svg",
       dpi = 320,
...
runModell <- function(modell_name ,modell_in){
  ...
  ggsave(filename = paste0("BatchCorrected/DESeq2/",modell_name,"/Graphs/",modell_name,"_Batch_Corrected_Data_Boxplot.svg"),
         height = 12,
         width = 8,
         plot = nbcd)
  ...
  ggsave(filename = paste0("BatchCorrected/DESeq2/",modell_name,"/Graphs/",modell_name,"_log10_Batch_Corrected_Data_Boxplot.svg"),
         height = 12,
         width = 8,
         plot = log10nbcd)
  ...
  ggsave(filename = paste0("BatchCorrected/DESeq2/",modell_name,"/Graphs/",modell_name,"_log2_Batch_Corrected_Data_Boxplot.svg"),
         height = 12,
         width = 8,
         plot = log2nbcd)
  ...
  normbcd <- ggplot(stack(as.data.frame(DESeq2::counts(dds1,normalized=TRUE))),
    ...
    theme(axis.text.x = element_text(angle = 90))
 ggsave(filename = paste0("BatchCorrected/DESeq2/",modell_name,"/Graphs/DESeq2_normalized_",modell_name,"_batch_corrected_Counts.svg"),
         plot = normbcd,
         width = 8,
         height = 12)
  ...
  log10normbcd <- ggplot(stack(as.data.frame(log10(DESeq2::counts(dds1,normalized=TRUE)))),
    ...
    theme(axis.text.x = element_text(angle = 90))
  ggsave(filename = paste0("BatchCorrected/DESeq2/",modell_name,"/Graphs/DESeq2_normalized_",modell_name,"_batch_corrected_log10_Counts.svg"),
         plot = log10normbcd,
         width = 8,
         height = 12)
  ...
  rlognormbcd <- ggplot(stack(as.data.frame(assay(rld))),
    ...
    theme(axis.text.x = element_text(angle = 90))
  ggsave(filename = paste0("BatchCorrected/DESeq2/",modell_name,"/Graphs/DESeq2_RLD_",modell_name,"_batch_corrected_Counts.svg"),
  ...
  ggsave(filename = paste0("BatchCorrected/DESeq2/",modell_name,"/Graphs/DESeq2_VSD_",modell_name,"_batch_corrected_Counts.svg"),
         plot = vsdnormbcd,
         height = 12,
         width = 8)
  ...
  #Gather them together
    ggsave(filename = paste0("BatchCorrected/DESeq2/",modell_name,"/Graphs/DESeq2_Normalizations_",modell_name,"_Counts.pdf"),
  ...
  ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/PCA_DESeq2_Normalized_",modell_name,"_batch_corrected_Counts.svg"),
         dpi = 320,
         device = "svg",
         plot = grid.arrange(p_norm_corrected_Lab,
                             p_norm_corrected_Plt,
  ...
  ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/PCA_DESeq2_RLD_",modell_name,"_batch_corrected_Counts.svg"),
         dpi = 320,
         device = "svg",
         plot = grid.arrange(p_norm_corrected_Lab,
                             p_norm_corrected_Plt,
  ...
  ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/PCA_DESeq2_VSD_",modell_name,"_batch_corrected_Counts.svg"),
         dpi = 320,
         device = "svg",
         plot = grid.arrange(p_norm_corrected_Lab,
                             p_norm_corrected_Plt,
  ...
  write.table(x = comparissons_realised,
              file = paste0("BatchCorrected/DESeq2/",
                            modell_name,
...
dir.create("Graphs_f/PCA/NORMALIZED/Length", recursive = TRUE)
ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/Length/PCA_DESeq2_Normalized_",modell_name,"_batch_corrected_Counts.svg"),
       dpi = 320,
       device = "svg",
...
```{r}
dir.create(recursive = TRUE,path = "Graphs_f/PCA/NORMALIZED/Length/")
...
lapply(names(pca_nrm_len_pc1_pc2_list),function(plotIt){
  ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/Length/PCA_NORMALIZED_Length",plotIt,"pc1_pc2_Counts.svg"),plot = pca_nrm_len_pc1_pc2_list[[plotIt]],device = "svg",dpi = 320,width = 12,height = 10)
...
dir.create("Graphs_f/UMAP/NORMALIZED/", recursive = TRUE)
ggsave(filename = paste0("Graphs_f/UMAP/NORMALIZED/UMAP_DESeq2_Normalized_",modell_name,"_batch_corrected_Counts.svg"),
       device = "svg",
       dpi = 320,
...
modell_name = "Length"
dir.create(recursive = TRUE,path = paste0("BatchCorrected/DESeq2/",modell_name))
dir.create(recursive = TRUE,path = paste0("BatchCorrected/DESeq2/",modell_name,"/Contrasts_Results"))
dir.create(recursive = TRUE,path = paste0("BatchCorrected/DESeq2/",modell_name,"/Graphs"))
...
dir.create("Graphs_f/PCA/NORMALIZED/Library/", recursive = TRUE)
ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/Library/PCA_DESeq2_Normalized_",modell_name,"_batch_corrected_Counts.svg"),
       dpi = 320,
       device = "svg",
...
lapply(names(pca_nrm_lib_pc1_pc2_list),function(plotIt){
  dir.create("Graphs_f/PCA/NORMALIZED/Library", recursive = TRUE)
  ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/Library/PCA_NORMALIZED_Library",plotIt,"pc1_pc2_Counts.svg"),plot = pca_nrm_lib_pc1_pc2_list[[plotIt]],device = "svg",dpi = 320,width = 12,height = 10)
...
dir.create("Graphs_f/PCA/NORMALIZED/Platform/", recursive = TRUE)
ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/Platform/PCA_DESeq2_Normalized_",modell_name,"_batch_corrected_Counts.svg"),
       dpi = 320,
       device = "svg",
...
lapply(names(pca_nrm_plt_pc1_pc2_list),function(plotIt){
  ...
  ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/Platform/PCA_NORMALIZED_Platform",plotIt,"pc1_pc2_Counts.svg"),plot = pca_nrm_plt_pc1_pc2_list[[plotIt]],device = "svg",dpi = 320,width = 12,height = 10)
...
dir.create("Graphs_f/UMAP/NORMALIZED", recursive = TRUE)
ggsave(filename = paste0("Graphs_f/UMAP/NORMALIZED/UMAP__Length_Platform_Library_normalized_Counts.svg"),
       device = "svg",
       dpi = 320,
       plot = grid.arrange(umap_deseq_length$umap_plot,
                           umap_deseq_platform$umap_plot,
...
```{r, fig.width=30,fig.height=10}
dir.create("Graphs_f/PCA/NORMALIZED", recursive = TRUE)
ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/PCA__Length_Platform_Library_normalized_Counts.svg"),
       device = "svg",
       dpi = 320,
       plot = grid.arrange(p_norm_Len_corrected_Lab,
...
p_norm_Plt_corrected_Tissue_pc1_2
```
...
dir.create("Graphs_f/PCA/NORMALIZED/Platform", recursive = TRUE)
ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/Platform/PCA_DESeq2_Normalized_",modell_name,"_batch_corrected_Counts_PC1_PC3.svg"),
       dpi = 320,
       device = "svg",
...
```{r}
dir.create(recursive = TRUE,path = "Graphs_f/PCA/NORMALIZED/Platform/PC1PC3")
...
lapply(names(pca_nrm_plt_pc1_pc3_list),function(plotIt){
  ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/Platform/PC1PC3/PCA_NORMALIZED_Platform",plotIt,"pc1_pc3_Counts.svg"),plot = pca_nrm_plt_pc1_pc3_list[[plotIt]],device = "svg",dpi = 320,width = 12,height = 10)
...
dir.create("Graphs_f/PCA/NORMALIZED/Platform/", recursive = TRUE)
  ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/Platform/PCA_DESeq2_Normalized_",modell_name,"_batch_corrected_Counts_PC1_PC4.svg"),
...
lapply(names(pca_nrm_plt_pc1_pc4_list),function(plotIt){
  dir.create("Graphs_f/PCA/NORMALIZED/Platform/PC1PC4/", recursive = TRUE)
  ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/Platform/PC1PC4/PCA_NORMALIZED_Platform",plotIt,"pc1_pc4_Counts.svg"),plot = pca_nrm_plt_pc1_pc4_list[[plotIt]],device = "svg",dpi = 320,width = 12,height = 10)
...
dir.create("Graphs_f/PCA/NORMALIZED/Platform/PC3PC4/", recursive = TRUE)
ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/Platform/PC3PC4/PCA_DESeq2_Normalized_",modell_name,"_batch_corrected_Counts_PC3_PC4.svg"),
       dpi = 320,
       device = "svg",
...
dir.create(recursive = TRUE,"Graphs_f/PCA/NORMALIZED/Platform/PC3PC4/")
lapply(names(pca_nrm_plt_pc3_pc4_list),function(plotIt){
  ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/Platform/PC3PC4/PCA_NORMALIZED_Platform",plotIt,"pc3_pc4_Counts.svg"),
...
dir.create("Graphs_f/PCA/NORMALIZED/Platform/PC4PC5/", recursive = TRUE)
ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/Platform/PC4PC5/PCA_DESeq2_Normalized_",modell_name,"_batch_corrected_Counts_PC4_PC5.svg"),
       dpi = 320,
       device = "svg",
...
lapply(names(pca_nrm_plt_pc4_pc5_list),function(plotIt){
  ggsave(filename = paste0("Graphs_f/PCA/NORMALIZED/Platform/PC4PC5/PCA_NORMALIZED_Platform",plotIt,"pc4_pc5_Counts.svg"),
...
#Load ensembl
ensembl=useEnsembl(biomart = "ENSEMBL_MART_ENSEMBL", dataset = "drerio_gene_ensembl",mirror = "www", version = 102)
...
dir.create("BatchCorrected/DESeq2/Platform/Contrasts_Results", recursive = TRUE)
lapply(names(lists_platform_batch_corrected_deseq_condition_ann),function(x)
  write.table(lists_platform_batch_corrected_deseq_condition_ann[[x]],
              paste0("BatchCorrected/DESeq2/Platform/Contrasts_Results/",x,"_ann_Platform.txt"),
              sep = "\t",
              row.names = TRUE,
              col.names = TRUE))
```
...
dir.create("BatchCorrected/edgeR/Platform/Contrasts_Results/", recursive = TRUE)
lapply(names(lists_platform_batch_corrected_edger_condition_ann),function(x)
  write.table(x = lists_platform_batch_corrected_edger_condition_ann[[x]],
              file = paste0("BatchCorrected/edgeR/Platform/Contrasts_Results/",x,"_ann_Platform.txt"),
              sep = "\t",
              row.names = TRUE,
              col.names = TRUE))
```
...
```{r}
lists_platform_batch_corrected_edger_condition_ann$Sham_vs_Uninjured |> mutate(convLogFC = logFC*(-1)) |> mutate(convlogCPM = logCPM*(-1)) |> write.table("BatchCorrected/edgeR/Platform/Contrasts_Results/Uninjured_vs_Sham_ann_Platform.txt",row.names = FALSE,col.names = TRUE,sep = "\t")
```
...
names(lists_platform_batch_corrected_deseq_condition_ann_fil) <- name_deseqs
#Save the data
lapply(names(lists_platform_batch_corrected_deseq_condition_ann_fil),function(x){
  write.table(x = lists_platform_batch_corrected_deseq_condition_ann_fil[[x]],
              file = paste0("BatchCorrected/DESeq2/Platform/Contrasts_Results/",x,"_ann_filtered_Platform.txt"),
              sep = "\t",
              row.names = FALSE,
              col.names = TRUE)})
...
lapply(names(lists_platform_batch_corrected_edger_condition_ann),function(x)
  write.table(x = lists_platform_batch_corrected_edger_condition_ann_fil[[x]],
              file = paste0("BatchCorrected/edgeR/Platform/Contrasts_Results/",x,"_ann_filtered_Platform.txt"),
              sep = "\t",
              row.names = FALSE,
              col.names = TRUE))
...
lapply(seq(1:length(ven_plot)),function(n){
  ggsave(device = "svg",dpi = 300,
         plot = ven_plot[[n]],
         filename =paste0("Graphs_f/EdgeR_vs_DESeq2_results_comparissons_",names(lists_platform_batch_corrected_edger_condition_ann_fil)[[n]],"edgeR_vs",names(lists_platform_batch_corrected_deseq_condition_ann_fil)[[n]],"_DESeq2.svg"),
  width = 12,
  height = 8)
  })
...
volcano_plot_function <- function(df_cond,lg2fc_p,log2fc_n,p_adj,title_,colordown,colorup,down_e,up_e,top_rows_to_select_genes){
        ...
        if(top_rows_to_select_genes!=0){
        df_cond_1 <- df_cond |>
          mutate(Regulation = ifelse(log2FoldChange > lg2fc_p & padj < p_adj,"UP",
                                     ifelse(log2FoldChange < log2fc_n & padj < p_adj,"DOWN","NO"))) |>
          dplyr::mutate(Regulation = ifelse(is.na(Regulation),"NO",Regulation)) |>
          dplyr::mutate(HS = ifelse(padj > (df_cond |> arrange(padj) |> 
                        slice_head(n = top_rows_to_select_genes)  |> slice_tail(n=1) |> pull(padj)),"NO","YES"))
        }else{   df_cond_1 <- df_cond |>
          mutate(Regulation = ifelse(log2FoldChange > lg2fc_p & padj < p_adj,"UP",
                                     ifelse(log2FoldChange < log2fc_n & padj < p_adj,"DOWN","NO"))) |>
          dplyr::mutate(Regulation = ifelse(is.na(Regulation),"NO",Regulation)) |>
          dplyr::mutate(HS = ifelse(padj > (df_cond |> arrange(padj) |> 
                      slice_tail(n=1) |> pull(padj)),"NO","YES"))
  ...
  p1 <- ggplot(data = df_cond_1,aes(x = log2FoldChange,y = -log10(padj),col = Regulation)) +
    ...
    geom_text_repel(nudge_y = 3.15, 
                    ...
                    color="black",size=12) +
    geom_point(position = position_jitter(height = 0.0000001, width = 0.0000001,seed = 123456),
...
```{r}
df_cond <-  lists_platform_batch_corrected_deseq_condition_ann$Ablated_vs_Sham
print(p1)
```
...
dir.create("Graphs_f/VOLCANOES/DESeq2", recursive = TRUE)
ggsave(filename = "Graphs_f/VOLCANOES/DESeq2/DESeq2_Conditions_vs_Sham_2.svg",
       device = "svg",
       limitsize = FALSE,
       width = 36,
       height = 52,
...
ggsave(filename = "Graphs_f/VOLCANOES/DESeq2/DESeq2_Ablated_vs_Sham_volc.svg",
       device = "svg",
       limitsize = FALSE,
       width = 210,
       height = 290,
...
ggsave(filename = "Graphs_f/VOLCANOES/DESeq2/DESeq2_Amputated_vs_Sham_volc.svg",
       device = "svg",
       limitsize = FALSE,
       width = 210,
       height = 290,
...
ggsave(filename = "Graphs_f/VOLCANOES/DESeq2/DESeq2_Cryoinjured_vs_Sham_volc.svg",
       device = "svg",
       limitsize = FALSE,
       width = 210,
       height = 290,
...
ggsave(filename = "Graphs_f/VOLCANOES/DESeq2/DESeq2_Uninjured_vs_Sham_volc.svg",
       device = "svg",
       limitsize = FALSE,
       width = 210,
       height = 290,
...
dir.create("Graphs_f/VENNS", recursive = TRUE)
ggsave(device = "svg",dpi = 300,plot = v_Sham_deseq_dr_entrez,
       filename=paste0("Graphs_f/VENNS/Danio_rerio_entrez_DEG_padj005_l2fc1_DESeq2.svg"),
  width = 12,
  height = 8)
...
ggsave(device = "svg",dpi = 300,plot = v_AblUninj_deseq_dr_entrez,
       filename=paste0("Graphs_f/VENNS/Danio_rerio_entrez_DEG_padj005_l2fc1_Abla_vs_Uninj_DESeq2.svg"),
  width = 12,
  height = 8)
...
ggsave(device = "svg",dpi = 300,plot = v_Sham_deseq_dr_ensembl,
       filename=paste0("Graphs_f/VENNS/Danio_rerio_ensembl_DEG_padj005_l2fc1_DESeq2.svg"),
  width = 12,
  height = 8)
```
```{r,fig.width=11,fig.height=8}
...
ggsave(device = "svg",dpi = 300,plot = v_AblaUninj_deseq_dr_ensembl,
       filename=paste0("Graphs_f/VENNS/Danio_rerio_ensembl_DEG_padj005_l2fc1_Ablated_vs_Uninjured_DESeq2.svg"),
  width = 12,
  height = 8)
```
...
ggsave(device = "svg",dpi = 300,plot = v_Sham_Uninjured_deseq_dr_ensembl,
       filename=paste0("Graphs_f/VENNS/Danio_rerio_Ablated_vs_Uninjured_ensembl_DEG_padj005_l2fc1_DESeq2_v2.svg"),
  width = 12,
  height = 8)
```
...
ggsave(device = "svg",dpi = 300,plot = v_Sham_Uninjured_deseq_dr_entrez,
       filename=paste0("Graphs_f/VENNS/Danio_rerio_Ablated_Uninjured_entrez_DEG_padj005_l2fc1_DESeq2_v2.svg"),
  width = 12,
  height = 8)
...
```{r}
#Save data.
dir.create("Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/dr2mmus/", recursive = TRUE)


write.table(x = Uninjured_vs_Sham_mouse_enriched_all_clean_mm,
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/dr2mmus/Uninjured_vs_Sham_mouse_enriched_all_clean.txt",sep = "\t",row.names = FALSE,col.names = TRUE,quote = FALSE)



write.table(x = Ablated_vs_Sham_mouse_enriched_all_clean_mm,
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/dr2mmus/Ablated_vs_Sham_mouse_enriched_all_clean.txt",
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE,
            quote = FALSE)
...
write.table(x = Cryonjury_vs_Sham_mouse_enriched_all_clean_mm,
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/dr2mmus/Cryonjury_vs_Sham_mouse_enriched_all_clean.txt",
            sep = "\t",row.names = FALSE,col.names = TRUE,quote = FALSE)



write.table(x = Amputation_vs_Sham_mouse_enriched_all_clean_mm,
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/dr2mmus/Amputation_vs_Sham_mouse_enriched_all_clean.txt",
            sep = "\t",row.names = FALSE,col.names = TRUE,quote = FALSE)

write.table(x = Ablated_vs_Uninjured_mouse_enriched_all_clean_mm,
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/dr2mmus/Ablated__vs_Uninjured_mouse_enriched_all_clean.txt",
            sep = "\t",row.names = FALSE,col.names = TRUE,quote = FALSE)
...
write.table(x = Uninjured_vs_Sham_mouse_enriched_fil_clean_mm,
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/dr2mmus/Uninjured_vs_Sham_mouse_enriched_fil_clean.txt",
            sep = "\t",row.names = FALSE,col.names = TRUE,quote = FALSE)



write.table(x = Ablated_vs_Sham_mouse_enriched_fil_clean_mm,
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/dr2mmus/Ablated_vs_Sham_mouse_enriched_fil_clean.txt",
            sep = "\t",row.names = FALSE,col.names = TRUE,quote = FALSE)



write.table(x = Cryonjury_vs_Sham_mouse_enriched_fil_clean_mm,
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/dr2mmus/Cryonjury_vs_Sham_mouse_enriched_fil_clean.txt",sep = "\t",
            row.names = FALSE,col.names = TRUE,quote = FALSE)

write.table(x = Amputation_vs_Sham_mouse_enriched_fil_clean_mm,
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/dr2mmus/Amputation_vs_Sham_mouse_enriched_fil_clean.txt",
            sep = "\t",row.names = FALSE,col.names = TRUE,quote = FALSE)

write.table(x = Ablated_vs_Uninjured_mouse_enriched_fil_clean_mm,
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/dr2mmus/Ablated__vs_Uninjured_mouse_enriched_fil_clean.txt",
            sep = "\t",row.names = FALSE,col.names = TRUE,quote = FALSE)
...
dir.create("Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/GOBP/", recursive = TRUE)
write.table(x = sham_bp_Mmus_05_v2_down$data,

            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/GOBP/Mmus_clean_gobp_enrichment_v2_abl_sham_downregulated_1.txt",
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE,
            quote = FALSE)
...
write.table(x = sham_bp_Mmus_05_v2_up$data,
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/GOBP/Mmus_clean_gobp_enrichment_v2_abl_sham_upregulated_1.txt",
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE,
            quote = FALSE)
...
write.table(x = sham_bp_Mmus_05_nv_c_3$data,
            ...
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/GOBP/Mmus_clean_gobp_enrichment_v3_abl_unj.txt",
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE,
            quote = FALSE)
...
write.table(x = sham_bp_Mmus_05_nv_c_2$data,
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/GOBP/Mmus_clean_gobp_enrichment_v2_abl_sham.txt",
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE,
            quote = FALSE)
...
dir.create("Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/GEM/GOBPUniques/", recursive = TRUE)
  a |> 
    write.table(paste0("Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/GEM/GOBPUniques/",text_Extra,"_",condition,"_vs_",control,".txt"),
                row.names = FALSE,
                col.names = TRUE,
                sep = "\t",
                quote = FALSE)
  ...
  e <- stats_data_condition[,c("MGI_Symbol","Description",b$ID)]
  e$Symbols <- noquote(e$Symbols)
  
  e |> 
  write.table(paste0("Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/GEM/GOBPUniques/",text_Extra,"_",condition,"_vs_",control,"_normalized_counts_expression_symbol_and_condition_enmap.txt"),
  ...
  write.table(x = b$Condition,
              file = paste0("Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/GEM/GOBPUniques/",text_Extra,"_",condition,"_vs_",control,"_names.cls"),
              sep = "\t",
              quote = FALSE,
              col.names = FALSE,
              row.names = FALSE)
...
dir.create("Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/GEM/", recursive = TRUE)
  
  a |>
    write.table(paste0("Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/GEM/",text_Extra,"_",condition,"_vs_",control,".txt"),
              row.names = FALSE,
              col.names = TRUE,
              sep = "\t",
              quote = FALSE)
  ...
  e |> write.table(paste0("Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/GEM/",text_Extra,"_",condition,"_vs_",control,"_normalized_counts_expression_symbol_and_condition_enmap.txt"),
                sep = "\t",
                row.names = FALSE,
                col.names = TRUE,
                quote = FALSE)
  ...
  write.table(x = b$Condition,
              ...
              file = paste0("Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/GEM/",text_Extra,"_",condition,"_vs_",control,"_names.cls"),
              sep = "\t",
              quote = FALSE,
...
write.table(x = rbind(amputated_intersect,
                      amputated_new,
                      amputated_old),
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/Amputation_comparissons_gobp_old_new_table.txt",
            col.names = TRUE,
            row.names = FALSE,
            sep = "\t")


amputated_plot <- rbind(
                      amputated_new,
                      amputated_old) |>
  arrange(desc(COMMON)) |>
  ggplot() +
...
write.table(x = rbind(ablated_intersect,
                      ablated_new,
                      ablated_old),
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/Ablation_comparissons_gobp_old_new_table.txt",
...
dir.create("Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/", recursive = TRUE)
write.table(x = rbind(uninjured_intersect,
                      uninjured_new,
                      uninjured_old),
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/setDiffConditions/Uninjured_comparissons_gobp_old_new_table.txt",
            col.names = TRUE,row.names = FALSE,sep = "\t")


uninjured_plot <- rbind(
                        uninjured_new,
                        uninjured_old) |>
  arrange(desc(COMMON)) |>
  ggplot() +
...
write.table(x = heart_regeneration_core_mm_v2,#[,c(0:10,16:51)],
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/coreRegeneration/GEM/heart_regeneration_core_mm_fil_v2_clean.txt",
            sep = "\t",row.names = FALSE,col.names = TRUE,quote = FALSE)
...
write.table(x = heart_regeneration_core_gobp_v3@result |> filter(p.adjust < 0.05),
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/coreRegeneration/GOBP/Mmus_clean_coreRegeneration_gobp_abl_uninjured_enrichment.txt",
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE,
            quote = FALSE)
write.table(x = heart_regeneration_core_gobp_v2@result |> filter(p.adjust < 0.05),
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/coreRegeneration/GOBP/Mmus_clean_coreRegeneration_gobp_abl_sham_enrichment.txt",
            sep = "\t",
            row.names = FALSE,
            col.names = TRUE,
            quote = FALSE)
```
```{r}
abl_core_counts <- Ablated_vs_Sham_mouse_enriched_fil_clean_mm |> filter(MGI_Symbol %in% heart_regeneration_core_mm_v2$MGI_Symbol) |>  distinct(MGI_Symbol,.keep_all = TRUE) |> select(MGI_Symbol,rownames(s4c)[s4c$Condition == "Ablated"])
```
...
amp_core_counts <- Amputation_vs_Sham_mouse_enriched_fil_clean_mm |> filter(MGI_Symbol %in% heart_regeneration_core_mm_v2$MGI_Symbol) |>  distinct(MGI_Symbol,.keep_all = TRUE) |>
  select(MGI_Symbol,rownames(s4c)[s4c$Condition == "Amputation"])
```
...
write.table(x = core_selected_counts_from,file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/coreRegeneration/core_selected_counts_148_Table.txt",
...
create_gem2 <- function(condition,stats_data_condition,enrichment_data,text_Extra){
  ...
  a |> 
    write.table(paste0("Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/coreRegeneration/GEM/heart_regeneration_core_mm_fil_",text_Extra,"_gobp.txt"),
                row.names = FALSE,
                col.names = TRUE,
                sep = "\t",
                quote = FALSE)
  ...
  e$MGI_Symbol <- toupper(e$MGI_Symbol)
    ...
    write.table(x = e,file = paste0("Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/coreRegeneration/GEM/heart_regeneration_core_mm_fil_clean_",text_Extra,"_normalized_counts_expression_symbol_and_condition_enmap.txt"),
                sep = "\t",
                row.names = FALSE,col.names = TRUE,
                quote = FALSE)
  #Save the classes.
   write.table(x = b$Condition,file = paste0("Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/coreRegeneration/GEM/heart_regeneration_core_mm_fil_clean_",text_Extra,"_names.cls"),
              sep = "\t",
              quote = FALSE,
              col.names = FALSE,row.names = FALSE)
  ...
  return(list(go_table_selected_condition = a,
              conditon_table=b,
              data_frame_ready_counts = e))  Sys.sleep(time = 15)
}
```
...
write.table(x = rbind(symbols_intersect,symbols_setdiff_abl_sham_core,symbols_setdiff_abl_uninj_core),
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/coreRegeneration/heart_regeneration_core_old_vs_new_table_genes.txt",
...
write.table(x = rbind(heart_core_intersect,
                      heart_core_new,
                      heart_core_old),
            file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/coreRegeneration/heart_regeneration_core_old_vs_new_table_gobp.txt",
            col.names = TRUE,row.names = FALSE,sep = "\t")


heart_core_plot <- rbind(
                        heart_core_new,
                        heart_core_old) |>
  arrange(desc(COMMON)) |>
  ggplot() +
...
volcano_plot_function <- function(df_cond,lg2fc_p,log2fc_n,p_adj,title_,colordown,colorup,down_e,up_e,top_rows_to_select_genes){
  ...
  p1 <- ggplot(data = df_cond_1,aes(x = log2FoldChange,y = -log10(padj),col = Regulation)) +
    ...
    geom_text_repel(nudge_y = 3.15, nudge_x = 0.91,
                    ...
                    color="black",size=8) +
    geom_point(position = position_jitter(height = 0.0000001, width = 0.0000001,seed = 123456),       pch=21,size=1.1,color="red",
               data = df_cond_1 |> filter(HS == "Yes"),
               aes(x = log2FoldChange,y = -log10(padj))) +
    geom_point(position = position_jitter(height = 0.0000001, width = 0.0000001,seed = 123456),       pch=21,size=1.2,color="red",
               data = df_cond_1 |> filter(HS == "Yes"),
               aes(x = log2FoldChange,y = -log10(padj)))
  return(list(plot=p1,data_volc = p1$data))}
```
...
### Save all
```{r}
save.image(file = "Outputs/r/Cytoscape/Cleaned_Annotation_Ensembl_v4/R/Workflow_cytoscape_gem_pca_volcano_goprofiler_v4_check_2.RData")
